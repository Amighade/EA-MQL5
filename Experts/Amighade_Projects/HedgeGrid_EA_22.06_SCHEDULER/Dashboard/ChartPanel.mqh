...
void UpdateDashboard(const GridState &state)
{
   ...
   HG_UpdateVal(PANEL_PREFIX "V4",  "FULL",                                             clrLime,                                             vx, RY(3));
   ...
   UpdateLabel(PANEL_PREFIX "V20",
      ...
      //InpLotIncreaseMode != LOT_INC_NONE  ?"+":"-", InpShiftAnchor != SHIFT_NONE ?"+":"-", InpEnableRecentering  ?"+":"-",
   string bricks = StringFormat("L%s S%s R%s I%s O%s",
      InpLotIncreaseMode != LOT_INC_NONE  ?"+":"-",
