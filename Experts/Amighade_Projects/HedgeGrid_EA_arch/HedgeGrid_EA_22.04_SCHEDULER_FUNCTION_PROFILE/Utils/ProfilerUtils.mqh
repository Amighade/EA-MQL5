//+------------------------------------------------------------------+
//| ProfilerUtils.mqh                                                |
//| REV 22.3 diagnostic function profiler                            |
//|                                                                  |
   ...
   switch(id)
     {
      ...
      case PROF_PLACE_PENDING_WIDENING: return "PlacePendingWithWidening";
      case PROF_PLACE_PENDING_ORDER: return "PlacePendingOrder";
      case PROF_ORDERSEND_PENDING: return "OrderSend.Pending";
      case PROF_WIDEN_SLEEP: return "Widen.Sleep";
      case PROF_DELETE_ORDER: return "DeleteOrder";
      case PROF_ORDERSEND_DELETE: return "OrderSend.Delete";
      ...
      case PROF_MODIFY_POSITION_SL: return "ModifyPositionSL";
      case PROF_ORDERSEND_MODIFY_SL: return "OrderSend.ModifySL";
      ...
      case PROF_ORDERSEND_ASYNC_DELETE: return "OrderSendAsync.Delete";
