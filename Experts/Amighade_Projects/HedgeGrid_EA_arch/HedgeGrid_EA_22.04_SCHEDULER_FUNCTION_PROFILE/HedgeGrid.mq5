...
{
   // REQUEST events are only useful to the scheduler while cleanup has
   // asynchronous requests in flight. Normal synchronous strategy requests
   // do not need to occupy the transaction queue.
