...
//+------------------------------------------------------------------+
//| [REV-2026-09-14-CLOSE-STYLE] why: same shape as                   |
//| CloseAllPositionsBySide, no side filter -- used by                |
//| StartCleanupSequence's bulk pre-pass when InpCloseStyle is BULK.   |
//| Cleanup isn't side-scoped like the loser purge is (it's a sweep of |
//| whatever's left, regardless of side), so this needs no side param.|
//+------------------------------------------------------------------+
